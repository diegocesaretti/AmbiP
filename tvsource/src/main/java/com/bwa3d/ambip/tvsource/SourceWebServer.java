...
/** API-26-safe HTTP diagnostics/settings server plus compact binary WebSocket light stream. */
public final class SourceWebServer {
    ...
    private void handle(Socket socket) {
        ...
        try {
            ...
            if("/health".equals(path))send(socket,"text/plain; charset=utf-8","OK AmbiP TV Source v3 binary\n".getBytes(StandardCharsets.UTF_8));
